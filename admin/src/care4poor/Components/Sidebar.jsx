...
const Sidebar = () => {
  ...
  const commonLinks = [
    // {
    //   to: "/care4poor/dashboard/dashboard",
    //   name: "Dashboard",
    //   icon: <FaTachometerAlt className="mr-2" />,
    // },
    {
      to: "/care4poor/dashboard/upload",
      name: "Upload",
      icon: <FaCloudUploadAlt className="mr-2" />,
    },
    {
      to: "/care4poor/dashboard/projects",
      name: "Projects",
      icon: <FaProjectDiagram className="mr-2" />,
    },
    {
      to: "/care4poor/dashboard/change-password",
  ...
  const adminLinks = [
    {
      to: "/care4poor/dashboard/user-list",
      name: "User List",
      icon: <FaList className="mr-2" />,
    },
    {
      to: "/care4poor/dashboard/add-user",
      name: "Add User",
