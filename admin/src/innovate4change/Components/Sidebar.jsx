...
const Sidebar = () => {
  ...
  const commonLinks = [
    // {
    //   to: "/innovate4change/dashboard/dashboard",
    //   name: "Dashboard",
    //   icon: <FaTachometerAlt className="mr-2" />,
    // },
    {
      to: "/innovate4change/dashboard/upload",
      name: "Upload",
      icon: <FaCloudUploadAlt className="mr-2" />,
    },
    {
      to: "/innovate4change/dashboard/projects",
      name: "Projects",
      icon: <FaProjectDiagram className="mr-2" />,
    },
    {
      to: "/innovate4change/dashboard/change-password",
  ...
  const adminLinks = [
    {
      to: "/innovate4change/dashboard/user-list",
      name: "User List",
      icon: <FaList className="mr-2" />,
    },
    {
      to: "/innovate4change/dashboard/add-user",
      name: "Add User",
  ...
  return (
    <>
      ...
      >
        <h1 className="text-2xl font-bold mb-6">innovate4change</h1>
