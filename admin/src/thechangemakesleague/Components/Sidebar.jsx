...
const Sidebar = () => {
  ...
  const commonLinks = [
    // {
    //   to: "/thechangemakersleague/dashboard/dashboard",
    //   name: "Dashboard",
    //   icon: <FaTachometerAlt className="mr-2" />,
    // },
    {
      to: "/thechangemakersleague/dashboard/upload",
      name: "Upload",
      icon: <FaCloudUploadAlt className="mr-2" />,
    },
    {
      to: "/thechangemakersleague/dashboard/projects",
      name: "Projects",
      icon: <FaProjectDiagram className="mr-2" />,
    },
    {
      to: "/thechangemakersleague/dashboard/change-password",
  ...
  const adminLinks = [
    {
      to: "/thechangemakersleague/dashboard/user-list",
      name: "User List",
      icon: <FaList className="mr-2" />,
    },
    {
      to: "/thechangemakersleague/dashboard/add-user",
      name: "Add User",
  ...
  return (
    <>
      ...
      >
        <h1 className="text-2xl font-bold mb-6">thechangemakersleague</h1>
