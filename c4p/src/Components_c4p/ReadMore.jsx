  ...
  useEffect(() => {
    ...
    const fetchProject = async () => {
      try {
        ...
        const res = await axios.get(`${API_BASE_URL}/api/c4p/projects/${id}`);
        setProject(res.data);
      } catch (error) {
    ...
    <div className="font-sans text-gray-800">
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <h1 className="text-4xl uppercase md:text-5xl font-bold leading-tight break-words">
            {project.title}
          </h1>
        </div>
      </section>
      ...
      <section className="flex flex-col md:grid md:grid-cols-2 p-6">
