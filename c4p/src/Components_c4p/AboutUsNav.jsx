...
const AboutUsNav = () => {
  ...
  return (
    <div className="font-sans bg-[#f9f6ef] text-gray-800">
      <section data-aos="fade-in" className="relative h-[500px] bg-black text-white flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-3xl md:text-5xl uppercase font-bold leading-tight">About Us</h1>
        </div>
      </section>

      <section data-aos="fade-up" className="py-16 px-6 md:px-20 bg-[#f9f6ef]">
