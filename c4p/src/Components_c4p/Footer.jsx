...
const Footer = () => {
  return (
    <footer className="bg-[#0a0f0d] text-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-white text-sm">
              <li><Link to="/about-us" className="hover:text-[#8ba07c]">↗ About Us</Link></li>
              <li><Link to="/more-project" className="hover:text-[#8ba07c]">↗ Projects</Link></li>
              <li><Link to="/join-us" className="hover:text-[#8ba07c]">↗ Join Us</Link></li>
              <li><Link to="/contact" className="hover:text-[#8ba07c]">↗ Contact Us</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                <p className="text-sm text-white">Call us any time:</p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm text-white">Email us any time:</p>
      ...
      <div className="bg-[#8ba07c] text-center py-4 text-white text-sm">
